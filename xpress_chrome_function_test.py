...
chrome_path = "C:\Python36\selenium_driver_chrome\chromedriver.exe" #chromedriver.exe執行檔所存在的路徑
...
"""driver.find_element_by_xpath("/html/body/app-root/div[2]/app-dashboard/div/div[1]/div[2]").click() #點選Account
driver.find_element_by_xpath("//*[@id='country_tx']/option[6]").click()  #選Country
driver.find_element_by_css_selector("#country_tx").click()  
driver.find_element_by_xpath("//*[@id='country_tx']/option[2]").click()
driver.find_element_by_css_selector("#state_tx").click()                     #選State/Region
driver.find_element_by_css_selector("#state_tx > option:nth-child(4)").click() 
driver.find_element_by_xpath("/html/body/app-root/div[2]/app-user/div/div/div/div[2]/div[2]/div/div[2]/form/button").click()
time.sleep(2)
alert = driver.switch_to_alert() #確認update info
alert.accept()
driver.find_element_by_xpath("/html/body/app-root/div[1]/nav/div[1]/a").click() #按Getac logo回上頁
driver.find_element_by_xpath("/html/body/app-root/div[2]/app-dashboard/div/div[2]/div[2]/button").click() #按 deployXpress
time.sleep(3)"""
...
"""driver.find_element_by_xpath("/html/body/app-root/div[2]/app-deployxpress/app-qr-generator/app-target-device/div/div/div[2]/form/div[4]/app-custom-select/div/button").click()#select group#
driver.implicitly_wait(4)
driver.find_element_by_xpath("//*[@id='drop']/li[5]").click() #選group xxx ,li[]數字會因group數而定
driver.implicitly_wait(4)"""
...
driver.implicitly_wait(2)
driver.find_element_by_xpath("/html/body/app-root/div[2]/app-deployxpress/app-qr-generator/app-target-device/div/div/div[2]/form/div[4]/button").click()#click next#
driver.implicitly_wait(4)
...
time.sleep(1)
#driver.find_element_by_xpath("//*[@id='Brightness']").send_keys("128") #亮度調到128
#time.sleep(1)
driver.find_element_by_xpath("/html/body/app-root/div[2]/app-deployxpress/app-qr-generator/app-config-main/div/div[2]/app-config-panel/div/div/div[2]/app-dynamic-form/div/form/div/div[3]").click()
time.sleep(1)
...
#driver.find_element_by_xpath("/html/body/app-root/div[2]/app-deployxpress/app-qr-generator/app-config-main/div/div[3]/div[6]/button").click() #click Generate btn to generate 3個 QR code
time.sleep(1)
...
try:  
    ...
    print ('Test pass: Complete generation success for 6.0')  
except Exception as e:
...
driver.find_element_by_xpath("/html/body/app-root/div[2]/app-deployxpress/app-qr-generator/app-qr-distribute/app-more-actions/div/div/div/div[1]/button").click() #Close More actions
time.sleep(4)

#/html/body/app-root/div[2]/app-deployxpress/app-qr-generator/app-qr-distribute/div/div/div[3]/div[3]/button[2] #Send button
#driver.back() #回上一頁
...
"""driver.find_element_by_id("step-device").click() # Click Set Target
time.sleep(2)
driver.find_element_by_xpath("/html/body/app-root/div[2]/app-deployxpress/app-qr-generator/app-confirm-modal/div/div/div/div[2]/div[2]/button[2]").click() #Click OK
time.sleep(4)
driver.find_element_by_xpath("/html/body/app-root/div[2]/app-deployxpress/app-qr-generator/app-target-device/div/div/div[2]/form/div[4]/button").click() #Click Next
driver.implicitly_wait(4)
...
driver.find_element_by_xpath("/html/body/app-root/div[2]/app-deployxpress/app-qr-generator/app-config-main/div/div[1]/div[1]/div[2]/ul/li[5]").click()#Wireless & Networks /  Networking Miscellaneous
time.sleep(1)
driver.find_element_by_xpath("/html/body/app-root/div[2]/app-deployxpress/app-qr-generator/app-config-main/div/div[3]/div[9]/button").click() #click Generate btn to generate QR code
time.sleep(1)
driver.find_element_by_xpath("//*[@id='qrcode_string']").send_keys("Auto test QR code")
time.sleep(1)
...
try:  
    driver.find_element_by_xpath("/html/body/app-root/div[2]/app-deployxpress/app-qr-generator/app-config-main/app-name-confirm/div/div/div/div[1]/span")  
    print ('Test pass: Complete generation success for 5.1')  
except Exception as e:
    print ("Exception found", format(e))  #判斷QR code Complete generation成功
